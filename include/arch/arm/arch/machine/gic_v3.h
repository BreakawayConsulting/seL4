...
/* FIXME: Define virt control registers for AARCH32 */
#endif
...
{
    /* FIXME: there are 8 APR registers in GICv3, so this is unlikely
     * to be a suitable mapping
     */
    uint32_t reg;
...
{
    /* FIXME: GICv3 only has a single EISR register, and only 16-bits are used.
     * We just return zero here instead, but we really need to check the callsite
...
static inline virq_t get_gic_vcpu_ctrl_lr(int num)
{
    ...
    uint64_t reg = 0;
    switch (num) {
        case 0: MRS(ICH_LR0_EL2, reg); break;
        case 1: MRS(ICH_LR1_EL2, reg); break;
        case 2: MRS(ICH_LR2_EL2, reg); break;
        case 3: MRS(ICH_LR3_EL2, reg); break;
        case 4: MRS(ICH_LR4_EL2, reg); break;
        case 5: MRS(ICH_LR5_EL2, reg); break;
        case 6: MRS(ICH_LR6_EL2, reg); break;
        case 7: MRS(ICH_LR7_EL2, reg); break;
        case 8: MRS(ICH_LR8_EL2, reg); break;
        case 9: MRS(ICH_LR9_EL2, reg); break;
        case 10: MRS(ICH_LR10_EL2, reg); break;
        case 11: MRS(ICH_LR11_EL2, reg); break;
        case 12: MRS(ICH_LR12_EL2, reg); break;
        case 13: MRS(ICH_LR13_EL2, reg); break;
        case 14: MRS(ICH_LR14_EL2, reg); break;
        case 15: MRS(ICH_LR15_EL2, reg); break;
        /* FIXME: What is the right behaviour when not valid? */
    }
    virq.words[0] = reg;
    return virq;
}
...
static inline void set_gic_vcpu_ctrl_lr(int num, virq_t lr)
{
    ...
    switch (num) {
        case 0: MSR(ICH_LR0_EL2, reg); break;
        case 1: MSR(ICH_LR1_EL2, reg); break;
        case 2: MSR(ICH_LR2_EL2, reg); break;
        case 3: MSR(ICH_LR3_EL2, reg); break;
        case 4: MSR(ICH_LR4_EL2, reg); break;
        case 5: MSR(ICH_LR5_EL2, reg); break;
        case 6: MSR(ICH_LR6_EL2, reg); break;
        case 7: MSR(ICH_LR7_EL2, reg); break;
        case 8: MSR(ICH_LR8_EL2, reg); break;
        case 9: MSR(ICH_LR9_EL2, reg); break;
        case 10: MSR(ICH_LR10_EL2, reg); break;
        case 11: MSR(ICH_LR11_EL2, reg); break;
        case 12: MSR(ICH_LR12_EL2, reg); break;
        case 13: MSR(ICH_LR13_EL2, reg); break;
        case 14: MSR(ICH_LR14_EL2, reg); break;
        case 15: MSR(ICH_LR15_EL2, reg); break;
        /* FIXME: What is the right behaviour when not valid? */
    }
}
