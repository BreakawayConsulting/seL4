...
if(KernelPlatImx6)
    ...
    list(APPEND KernelDTSList "../dts/${KernelARMPlatform}.dts")
    list(APPEND KernelDTSList "../dts/overlay-${KernelARMPlatform}.dts")

    if(KernelIsMCS)
        list(APPEND KernelDTSList "../dts/mcs-overlay-imx6.dts")
